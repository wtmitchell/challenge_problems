...
string problems::Problem4::answer() {
  if (!solved)
    solve();
...
std::string problems::Problem4::description() const {
  return "Problem 4: Largest palindrome product";
}

void problems::Problem4::solve() {
  unsigned int max = 0;
