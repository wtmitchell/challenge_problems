...
string problems::Problem15::answer() {
  if (!solved)
    solve();
...
std::string problems::Problem15::description() const {
  return "Problem 15: Lattice paths";
}

void problems::Problem15::solve() {
