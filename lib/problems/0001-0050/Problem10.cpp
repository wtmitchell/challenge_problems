...
string problems::Problem10::answer() {
  if (!solved)
    solve();
...
std::string problems::Problem10::description() const {
  return "Problem 10: Summation of primes";
}

void problems::Problem10::solve() {
  sum = sieveOfEratosthenes(2000000ull);
  solved = true;
}

unsigned long long
problems::Problem10::sieveOfEratosthenes(const unsigned long long limit) const {
