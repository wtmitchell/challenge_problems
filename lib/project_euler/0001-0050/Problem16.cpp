...
string project_euler::Problem16::answer() {
  if (!solved)
    solve();
...
std::string project_euler::Problem16::description() const {
  return "Problem 16: Power digit sum";
}

void project_euler::Problem16::solve() {
  mpz_class foo(0);
