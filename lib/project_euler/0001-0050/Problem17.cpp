...
string project_euler::Problem17::answer() {
  if (!solved)
    solve();
...
std::string project_euler::Problem17::description() const {
  return "Problem 17: Number letter counts";
}

void project_euler::Problem17::solve() {
  count = bruteForce3();
  solved = true;
}
...
unsigned long project_euler::Problem17::bruteForce2() const {
  unsigned long letters = 0;
...
unsigned long project_euler::Problem17::bruteForce3() const {
  unsigned long letters = 0;
