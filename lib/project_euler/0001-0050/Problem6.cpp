...
string project_euler::Problem6::answer() {
  if (!solved)
    solve();
...
std::string project_euler::Problem6::description() const {
  return "Problem 6: Sum square difference";
}

void project_euler::Problem6::solve() {
  difference = faster(100);
  solved = true;
}

unsigned project_euler::Problem6::bruteForce(const unsigned limit) const {
...
unsigned project_euler::Problem6::faster(const unsigned limit) const {
