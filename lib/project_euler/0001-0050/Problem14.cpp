...
string project_euler::Problem14::answer() {
  if (!solved)
    solve();
...
std::string project_euler::Problem14::description() const {
  return "Problem 14: Longest Collatz sequence";
}

void project_euler::Problem14::solve() {
  start = faster(1000000ull, 500000);
  solved = true;
}

unsigned long long
project_euler::Problem14::bruteForce(const unsigned long long limit) const {
  auto maxLength = 0ull;
  auto maxStart = 0ull;
...
unsigned long long project_euler::Problem14::faster(
